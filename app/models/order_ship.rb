class OrderShip
  ...
  with_options presence: true do
    ...
    def save
      ...
      Ship.create(post_code: post_code, address: address, prefecture_id: prefecture_id, city: city, phone_number: phone_number, building_name: building_name, order_id: order.id)
    end
end